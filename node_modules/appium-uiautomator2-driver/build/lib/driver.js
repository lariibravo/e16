...
class AndroidUiautomator2Driver extends appium_android_driver_1.default {
    constructor(opts = {}, shouldValidateCaps = true) {
        ...
        this.getClipboard = misc_1.getClipboard;
        ...
        this.performActions = touch_1.performActions;
        this.releaseActions = touch_1.releaseActions;
    ...
    async createSession(w3cCaps1, w3cCaps2, w3cCaps3, driverData) {
        try {
            ...
            if (this.isChromeSession) {
                ...
                const { pkg, activity } = appium_android_driver_1.utils.getChromePkg(this.opts.browserName);
    ...
    async startUiAutomator2Session(caps) {
        ...
        if (apiLevel >= 28) {
            ...
            try {
                ...
                this.log.errorAndThrow('Hidden API policy (https://developer.android.com/guide/app-compatibility/restrictions-non-sdk-interfaces) cannot be enabled. ' +
