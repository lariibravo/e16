...
import { tap, touchLongClick, touchDown, touchUp, touchMove, doSwipe, doTouchDrag, doTouchAction, performMultiAction, performTouch, doPerformMultiAction } from './commands/touch';
...
declare class AndroidDriver extends BaseDriver<AndroidDriverConstraints, StringRecord> implements ExternalDriver<AndroidDriverConstraints, string, StringRecord> {
    ...
    supportedLogTypes: {
        logcat: {
            description: string;
            getter: (self: AndroidDriver) => string[];
        };
        bugreport: {
            description: string;
            getter: (self: AndroidDriver) => Promise<{
                timestamp: number;
                level: string;
                message: string;
            }[]>;
    ...
    doTouchDrag: typeof doTouchDrag;
    doTouchAction: typeof doTouchAction;
    performMultiAction: typeof performMultiAction;
    performTouch: typeof performTouch;
